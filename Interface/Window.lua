...
function LRP:CreateWindow(name, exitable, movable, resizable)
    ...
    if exitable then
        window:AddButton(
            "Interface\\Addons\\AuraUpdater\\Media\\Textures\\ExitCross.tga",
            function()
                window:Hide()
            end
        )
    ...
    if resizable then
        ...
        window.resizeFrame.tex:SetTexture("Interface\\Addons\\AuraUpdater\\Media\\Textures\\ResizeTriangle.tga")
